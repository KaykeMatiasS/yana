...
= Aplicação de chat de Mensagens utilizando WebSocket com Node.js)

NOTE: Essa Playlist de vídeos foram usadas como base paara o processo de desenvolvimento do projeto https://www.youtube.com/watch?v=hEPAr4MPQjU&list=PLyo0RUAM69UvnqUq5SFeVahS_YTUVgq4v[aqui].
...
Instalação também de possiveis bibliotecas, como o express. Exemplo de instalação dela https://expressjs.com/en/starter/installing.html[Express]
